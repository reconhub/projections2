...
#'
#' This function calculates the force of infection (foi) at time t+1, generated
#' by cases with onset at time 1, 2, ..., t, with reproduction numbers R_1, R_2,
#' ..., R_t. Calculations use matrices where independent simulations are stored
#' as separate columns. This is the non-stratified, low-level function to
#' calculate the foi.
#'
...
compute_base_foi <- function(w, cases, R, t, instantaneous_R) {
  rev_w <- rev(w)
